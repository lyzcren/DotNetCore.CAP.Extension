...
{
    public class DamengMonitoringApi : IMonitoringApi
    {
        private readonly DamengOptions _options;
        private readonly string _pubName;
        private readonly string _recName;

        public DamengMonitoringApi(IOptions<DamengOptions> options, IStorageInitializer initializer)
        {
