...
{
    public class DamengCapTransaction : CapTransactionBase
    {
        public DamengCapTransaction(IDispatcher dispatcher) : base(dispatcher)
        {
        }
    ...
    public static class CapTransactionExtensions
    {
            ...
            ICapPublisher publisher, bool autoCommit = false)
        {
            ...
            publisher.Transaction.Value = ActivatorUtilities.CreateInstance<DamengCapTransaction>(publisher.ServiceProvider);
