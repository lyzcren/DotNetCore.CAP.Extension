...
namespace DotNetCore.CAP
{
    ...
    internal class ConfigureDamengOptions : IConfigureOptions<DamengOptions>
    {
        ...
        public void Configure(DamengOptions options)
        {
            ...
            {
                throw new InvalidOperationException("We detected that you are using ICapPublisher in DbContext, please change the configuration to use the storage extension directly to avoid circular references! eg:  x.UseDameng()");
            }
