...
{
    public class DamengDataStorage : IDataStorage
    {
        ...
        public MediumMessage StoreMessage(string name, Message content, object? dbTransaction = null)
        {
            ...
            object[] sqlParams =
            {
                new DmParameter(":Id", long.Parse(message.DbId)),
        ...
        public void StoreReceivedExceptionMessage(string name, string group, string content)
        {
            object[] sqlParams =
            {
                new DmParameter(":Id", SnowflakeId.Default().NextId()),
                new DmParameter(":Name", name),
                new DmParameter(":Group", group),
        ...
        public MediumMessage StoreReceivedMessage(string name, string group, Message message)
        {
            ...
            object[] sqlParams =
            {
                new DmParameter(":Id", long.Parse(mdMessage.DbId)),
                new DmParameter(":Name", name),
                new DmParameter(":Group", group),
                ...
                new DmParameter(":ExpiresAt", mdMessage.ExpiresAt.HasValue ? mdMessage.ExpiresAt.Value : DBNull.Value),
                new DmParameter(":StatusName", nameof(StatusName.Scheduled))
            };
        ...
        {
            return new DamengMonitoringApi(_options, _initializer);
        }
