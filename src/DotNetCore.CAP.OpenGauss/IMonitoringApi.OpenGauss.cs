...
{
    public class OpenGaussMonitoringApi : IMonitoringApi
    {
        private readonly OpenGaussOptions _options;
        private readonly string _pubName;
        private readonly string _recName;

        public OpenGaussMonitoringApi(IOptions<OpenGaussOptions> options, IStorageInitializer initializer)
        {
