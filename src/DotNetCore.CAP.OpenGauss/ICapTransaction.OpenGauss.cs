...
{
    public class OpenGaussCapTransaction : CapTransactionBase
    {
        public OpenGaussCapTransaction(IDispatcher dispatcher) : base(dispatcher)
        {
        }
    ...
    public static class CapTransactionExtensions
    {
            ...
            ICapPublisher publisher, bool autoCommit = false)
        {
            ...
            publisher.Transaction.Value = ActivatorUtilities.CreateInstance<OpenGaussCapTransaction>(publisher.ServiceProvider);
